...
else
{
    ...
    git add "source\Windows.Storage\Properties\AssemblyInfo.cs"
...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Storage/$env:GitVersion_NuGetVersionV2"
    ...
    $assemblyFiles = (Get-ChildItem -Path ".\*" -Include "win_storage_native.cpp" -Recurse)
    ...
    {
        $commitMessage = "Update Windows.Storage version to $env:GitVersion_NuGetVersionV2"
