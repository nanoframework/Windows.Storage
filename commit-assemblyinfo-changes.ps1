...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Storage/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update Windows.Storage version to $env:MyNuGetVersion"
