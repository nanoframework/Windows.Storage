...
namespace Windows.Storage
{
    ...
    public enum CreationCollisionOption
    {
        ...
        /// Methods that don't explicitly pass a value from the <see cref="CreationCollisionOption"/> enumeration use the FailIfExists value as the default when you try to create, rename, copy, or move a file or folder.
        /// </summary>
        FailIfExists = 2,
